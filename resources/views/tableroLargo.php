                ...
                <div class="col-xs-12 content_img1">
                    ...
                    <div class="col-xs-2 imgStreet">
                        ...
                        <div class="posicion4" id="posicion_5"> 
                            <img class="posicionGris" style="display:none;" src="../../resources/assets/imagenes_nuevas/PNG/Botonera/gris/botones_Conjunto-de-datos-9_Conjunto-de-datos-5.png"> 
                            <img class="posicionVerde" style="display:block;" src="../../resources/assets/imagenes_nuevas/PNG/Botonera/verde/botones_Conjunto-de-datos-9_Conjunto-de-datos-5.png">
                            <img class="posicionAzul"  src="../../resources/assets/imagenes_nuevas/PNG/Botonera/azul/botones_Conjunto-de-datos-5.png">
                            <div class="btnUser1" id="" type="submit" onclick=""> </div>
                        </div>
                ...
                <div class="col-xs-12 content_img2">
                    ...
                    <div class="col-xs-2 imgStreet"> 
                        ...
                        <div class="posicion8" id="posicion_13"> 
                            <img class="posicionGris" style="display:none;"  src="../../resources/assets/imagenes_nuevas/PNG/Botonera/gris/botones_Conjunto-de-datos-9_Conjunto-de-datos-14.png">
                            ...
                            <img class="posicionAzul" style="display:block;"  src="../../resources/assets/imagenes_nuevas/PNG/Botonera/azul/botones_Conjunto-de-datos-14.png"> 
                            <div class="btnUser2" id="" type="submit" onclick=""> </div>
                        </div>
                    </div>
                ...
                <div class="col-xs-12 content_img3">
                    ...
                    <div class="col-xs-2 imgStreet">
                        ...
                        <div class="posicion3" id="posicion_18"> 
                            <img class="posicionGris" style="display:none;" src="../../resources/assets/imagenes_nuevas/PNG/Botonera/gris/botones_Conjunto-de-datos-9_Conjunto-de-datos-18.png">
                            ...
                            <img class="posicionAzul" style="display:block;" src="../../resources/assets/imagenes_nuevas/PNG/Botonera/azul/botones_Conjunto-de-datos-18.png">  
                            <div class="btnUser3" id="" type="submit" onclick=""> </div>
                        </div>
                    </div>
